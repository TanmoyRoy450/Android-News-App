...
public class Utils {
    ...
    public static String DateFormat(String oldstringDate){
        String newDate;
        SimpleDateFormat dateFormat = new SimpleDateFormat("EEEE, d MMM yyyy", Locale.US);
        try {
    ...
    public static String getLanguage(){
        String language = String.valueOf(ConfigurationCompat.getLocales(Resources.getSystem().getConfiguration()));
        return language;
    }
